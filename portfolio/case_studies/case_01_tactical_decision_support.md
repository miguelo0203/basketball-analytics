...
│    • True Shooting % ajustado por contracción bayesiana (λ=0.75) y mano dominante.     │
├────────────────────────────────────────────────────────────────────────────────────────┤
│ 3. ALERTAS DE CONTRADICCIÓN TÁCTICA Y 3 CLAVES PARA EL VÍDEO                           │
│    • Cruce automático entre estadística y cinta (420 situaciones P&R, κ=0.80).         │
│    • Ejemplo: Alerta de vulnerabilidad si el rival defiende en 'Drop' profundo.        │
└────────────────────────────────────────────────────────────────────────────────────────┘
```
...
- **Contradicción Táctica**: Los pívots estadounidenses realizaban un *Drop* muy profundo para tapar penetraciones, concediendo tiros liberados en pick-and-pop a pívots con rango exterior.
- **Ajustes en el Brief**:
  1. *Ritmo*: Bajar el partido a menos de 72 posesiones mediante ataques de más de 16 segundos.
  2. *Defensa*: Plantear zona 2-3 tras canasta propia para frenar el contraataque rápido.
  3. *Ataque*: Castigar el drop con triples de Pau Gasol, Marc Gasol y Jorge Garbajosa.
...
- Capacidad de **comunicación directa con entrenadores** sin tecnicismos matemáticos.
- Integración real de **datos + vídeo táctico**.
- Enfoque centrado en la **resolución de problemas de partido**.
