# Professional Tactical Scouting Brief: Rudy Fernández
## Campaign: eurobasket_2009 (ESP) | Analyst-to-Scout Handoff

---

## 1. Quantitative Baseline & Analytical Profile

- **Assigned Quantitative Archetype**: `Low-Block Anchor / Interior Scorer`
- **Recruitment Fit Index**: `85.0 / 100.0`
- **Tournament Exposure**: `237.2 Minutes` across `9 Games` (`HIGH RELIABILITY`)
- **Key Quantitative Rates**:
  - True Shooting ($TS%$): `63.7%`
  - 3-Point Attempt Rate ($3PAr$): `20.8%`
  - Estimated Assist Rate ($AST%$): `9.9%`
  - Defensive Event Generation ($STL/40$): `1.5`

---

## 2. Video Tactical Validation Summary

- **Observed Film Archetype**: `Low-Block Anchor / Interior Scorer`
- **Quantitative $\leftrightarrow$ Video Agreement**: **STRONG AGREEMENT**
- **Observed Mean Tactical Quality**: `3.23 / 4.0`
- **Sample Power**: `22 Actions` reviewed across 3 competitive tournament games.
