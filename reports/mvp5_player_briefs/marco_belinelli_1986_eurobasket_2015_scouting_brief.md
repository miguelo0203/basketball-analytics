# Professional Tactical Scouting Brief: Marco Belinelli
## Campaign: eurobasket_2015 (ITA) | Analyst-to-Scout Handoff

---

## 1. Quantitative Baseline & Analytical Profile

- **Assigned Quantitative Archetype**: `Primary Initiator / Floor General`
- **Recruitment Fit Index**: `85.0 / 100.0`
- **Tournament Exposure**: `247.5 Minutes` across `8 Games` (`HIGH RELIABILITY`)
- **Key Quantitative Rates**:
  - True Shooting ($TS%$): `65.8%`
  - 3-Point Attempt Rate ($3PAr$): `17.8%`
  - Estimated Assist Rate ($AST%$): `57.6%`
  - Defensive Event Generation ($STL/40$): `1.3`

---

## 2. Video Tactical Validation Summary

- **Observed Film Archetype**: `Primary Initiator / Floor General`
- **Quantitative $\leftrightarrow$ Video Agreement**: **STRONG AGREEMENT**
- **Observed Mean Tactical Quality**: `3.05 / 4.0`
