# Professional Tactical Scouting Brief: Andreas Obst
## Campaign: worldcup_2023 (GER) | Analyst-to-Scout Handoff

---

## 1. Quantitative Baseline & Analytical Profile

- **Assigned Quantitative Archetype**: `Stretch Big / Pick-and-Pop Forward`
- **Recruitment Fit Index**: `85.0 / 100.0`
- **Tournament Exposure**: `40.0 Minutes` across `8 Games` (`HIGH RELIABILITY`)
- **Key Quantitative Rates**:
  - True Shooting ($TS%$): `0.0%`
  - 3-Point Attempt Rate ($3PAr$): `0.0%`
  - Estimated Assist Rate ($AST%$): `0.0%`
  - Defensive Event Generation ($STL/40$): `0.0`

---

## 2. Video Tactical Validation Summary

- **Observed Film Archetype**: `Stretch Big / Pick-and-Pop Forward`
