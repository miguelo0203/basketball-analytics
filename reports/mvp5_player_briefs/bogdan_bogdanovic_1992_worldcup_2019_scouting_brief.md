# Professional Tactical Scouting Brief: Bogdan Bogdanović
## Campaign: worldcup_2019 (SRB) | Analyst-to-Scout Handoff

---

## 1. Quantitative Baseline & Analytical Profile

- **Assigned Quantitative Archetype**: `Perimeter Movement Shooter / Spacer`
- **Recruitment Fit Index**: `85.0 / 100.0`
- **Tournament Exposure**: `224.0 Minutes` across `8 Games` (`HIGH RELIABILITY`)
- **Key Quantitative Rates**:
  - True Shooting ($TS%$): `48.9%`
  - 3-Point Attempt Rate ($3PAr$): `93.8%`
  - Estimated Assist Rate ($AST%$): `21.5%`
  - Defensive Event Generation ($STL/40$): `1.4`

---

## 2. Video Tactical Validation Summary

- **Observed Film Archetype**: `Perimeter Movement Shooter / Spacer`
- **Quantitative $\leftrightarrow$ Video Agreement**: **STRONG AGREEMENT**
- **Observed Mean Tactical Quality**: `3.23 / 4.0`
- **Sample Power**: `44 Actions` reviewed across 3 competitive tournament games.
...
**SCOUTING RECOMMENDATION**: **ADVANCE**
