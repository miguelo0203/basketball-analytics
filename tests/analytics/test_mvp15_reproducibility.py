...
def test_mvp15_artifacts_exist():
    ...
    required_files = [
        ...
        PROJECT_ROOT / "reports" / "mvp28_project_integrity_audit.md",
        PROJECT_ROOT / "CITATION.cff",
        PROJECT_ROOT / "data" / "README.md",
        PROJECT_ROOT / "presentation" / "README.md",
        PROJECT_ROOT / "presentation" / "International_Basketball_Analytics_Presentation.pdf",
        PROJECT_ROOT / "presentation" / "International_Basketball_Analytics_Presentation.pptx",
        PROJECT_ROOT / "portfolio" / "case_studies" / "README.md",
        PROJECT_ROOT / "portfolio" / "case_studies" / "case_01_tactical_decision_support.md",
        PROJECT_ROOT / "portfolio" / "case_studies" / "case_02_data_engineering_olap_duckdb.md",
        PROJECT_ROOT / "portfolio" / "case_studies" / "case_03_calibrated_ml_walk_forward.md",
        PROJECT_ROOT / "portfolio" / "case_studies" / "case_04_longitudinal_shooting_and_roles.md",
